...
public class TileEntityEnergyStorageQuadrupleCompressedMFSU extends TileEntityEnergyStorageBase {
	
	public TileEntityEnergyStorageQuadrupleCompressedMFSU() {
		super(CommonConfig.energystorage.quadruplecompressedmfsu);
	}
