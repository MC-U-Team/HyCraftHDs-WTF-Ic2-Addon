...
public class TileEntityEnergyStorageCompressedMFSU extends TileEntityEnergyStorageBase {
	
	public TileEntityEnergyStorageCompressedMFSU() {
		super(CommonConfig.energystorage.compressedmfsu);
	}
